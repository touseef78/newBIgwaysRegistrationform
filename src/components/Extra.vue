...
export default {
    ...
    methods: {
        ...
        // setActive(request_type) {
        //     this.isActive = request_type;
        //     this.fetchData(request_type);
        // },
        // fetchData(request_type) {
        //     this.loading = true;
        //     axios.get(`https://backendbigways.singsavatech.com/api/${request_type}Data`)
        //         .then(response => {
        //             if (request_type === 'public') {
        //                 this.zones = response.data.zones;
        //                 this.schools = response.data.schools;
        //                 this.vehicleType = 'public'; // Set the vehicle type if needed
        //             } else if (request_type === 'private') {
        //                 this.zones = response.data.zones;
        //                 this.schools = response.data.schools;
        //                 this.vehicleType = 'private'; // Set the vehicle type if needed
        //             }
        //         })
        //         .catch(error => {
